    ...
    <main className="site-shell">
      ...
      <section className="hero-section container-shell">
        <div className="hero-copy">
          ...
          <h2 className="hero-title">
            A restaurant experience that feels premium, with seamless ordering.
          </h2>
        ...
        <div className="section-head">
          <div>
            ...
            <h3 className="section-title">
              Handpicked favorites our clients keep coming back for
            </h3>
          </div>
        </div>
      ...
      <section id="menu" className="container-shell section-space">
        <div className="section-head">
          <div>
            <p className="section-eyebrow">Explore Our Menu</p>
            <h3 className="section-title">
              Freshly prepared meals crafted with quality ingredients and attention to detail
            </h3>
            <p className="section-text">
              Every plate is made to satisfy, impress, and keep you coming back.
            </p>
